...
migrateup:
	migrate -path db/migration -database "postgresql://root:dbsecret@localhost:5432/go-bank-v2?sslmode=disable" -verbose up

migratedown:
	migrate -path db/migration -database "postgresql://root:dbsecret@localhost:5432/go-bank-v2?sslmode=disable" -verbose down
